# graphql-go [![Sourcegraph](https://sourcegraph.com/github.com/marksauter/graphql-go/-/badge.svg)](https://sourcegraph.com/github.com/marksauter/graphql-go?badge) [![Build Status](https://semaphoreci.com/api/v1/marksauter/graphql-go/branches/master/badge.svg)](https://semaphoreci.com/marksauter/graphql-go) [![GoDoc](https://godoc.org/github.com/marksauter/graphql-go?status.svg)](https://godoc.org/github.com/marksauter/graphql-go)
...
We're trying out the GitHub Project feature to manage `graphql-go`'s [development roadmap](https://github.com/marksauter/graphql-go/projects/1).
...
import (
        ...
        "github.com/marksauter/graphql-go/relay"
)
